<div>
    ...
    <form action="{{route('fmt.lartrm.store')}}" method="post" class="fmt_box" enctype="multipart/form-data">
        ...
        <div>
            ...
            <textarea class="fmt_input"  name="question" id="" cols="30" rows="4" placeholder="question"></textarea>
        </div>
        ...
        <div>
            ...
            <input class="fmt_input" type="file" accept="audio/*" name="question_media" placeholder="Question" required>
        </div>
        <div>
            <label class="fmt_label" for="">Answer</label>
            <textarea class="fmt_input"  name="answer" id="" cols="30" rows="4" placeholder="Answer"></textarea>
        </div>
        <div>
...
{{--  --}}
<form action="{{route('fmt.lartrm.csv')}}" method="POST" enctype='multipart/form-data' style="margin:20px 40px;">
    @csrf
    <input type="integer" name="problem_set_id" value="{{$pbs72 ?? ''}}" hidden style="border:1px solid #000000;">
    <input type="integer" name="format_type_id" value="{{$fmt72 ?? ''}}" hidden style="border:1px solid #000000;">
